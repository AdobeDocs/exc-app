...
> [Globals](../README.md) / [nps](../modules/nps.md) / Nps
...
* [NpsApiProperties](nps.npsapiproperties.md)
...
* [config](nps.nps-1.md#config)

### Methods

* [triggerNps](nps.nps-1.md#triggernps)
...
*Inherited from [NpsApiProperties](nps.npsapiproperties.md).[config](nps.npsapiproperties.md#config)*
